...
For external monetary stability, an adequate amount of foreign currencies (foreign reserves) is maintained to meet the country's foreign currency demands to pay for imports and other obligations. As such, the Reserve Bank's monetary policies aim to ensure that Tonga always has foreign reserve holdings of at least three to four months of import cover.
...
\subsection{NRBT's Monetary Policy Stance}

In 2025, the NRBT announced its transition to a neutral policy stance. What im hearing is a corridor mid rate, improved communication and transparency, a revised Exchange Rate Policy Framework, and measures to boost liquidity.


% Easing stance as of recently in order to allow liquidity in the economy. 
%Intermediary (banks), integration with Fiscal policy (MOF), 

%Unsterililzed foreign exchange - persistently high excess liquidity (Graph of high excess liquidity)

%Inactive Interbank Market - weak MP transmission.

%Underdeveloped financial market - capital flight is very easy. 
